...
def fiducial_prediction(assembly_type, pos, new_fds, old_fds):
    ...
    if len(res) == 0:
        ...
        CH191 = [new_fds[0] + x_distance*cos(rotation), new_fds[1] + y_distance*sin(rotation),Z_avg]
        CH8 = [new_fds[0] + x_distance*sin(rotation), new_fds[1] + y_distance*cos(rotation),Z_avg]
        CH197 = [predicted[1][0] + x_distance*sin(rotation), predicted[1][1] + y_distance*cos(rotation),Z_avg]
